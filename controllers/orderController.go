...
func CreateOrder() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if order.Table_id != nil {
			err := tableCollection.FindOne(ctx, bson.M{"table_id": order.Table_id}).Decode(&order)
			defer cancel()
			if err != nil {
...
func UpdateOrder() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if order.Table_id != nil {
			err := orderCollection.FindOne(ctx, bson.M{"order_id": order.Table_id}).Decode(&table)
			defer cancel()
			if err != nil {
